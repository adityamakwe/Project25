...
class SubjectListCtl(BaseCtl):
    ...
    def new(self, request, params = {}):
        return redirect("/ORS/Subject/")

    def deleteRecord(self, request, params = {}):

        if not self.form['ids']:
            self.form['error'] = True
            self.form['message'] = "Select at least one record"
        else:
            ...
            for id in self.form['ids']:
                ...
                if subject:
                    ...
                    self.form['message'] = "Record deleted successfully"

                else:
                    self.form['error'] = True
                    self.form['message'] = "Record not deleted "
